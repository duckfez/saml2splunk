...
import (
	"fmt"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/netiq"
	"sort"

	"github.com/duckfez/saml2splunk/v2/pkg/cfg"
	"github.com/duckfez/saml2splunk/v2/pkg/creds"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/aad"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/adfs"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/adfs2"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/akamai"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/f5apm"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/googleapps"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/jumpcloud"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/keycloak"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/okta"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/onelogin"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/pingfed"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/pingone"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/shell"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/shibboleth"
	"github.com/duckfez/saml2splunk/v2/pkg/provider/shibbolethecp"
)
